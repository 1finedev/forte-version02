...
const handler = async (req, res) => {
  ...
  try {
    ...
    //   const date2 = endOfDay(new Date(Date.now()));
    //   const shipment = await Shipment.find({
    //     createdAt: {
    //       $gte: date1,
    //       $lte: date2,
    ...
    // //       setTimeout(() => {
    // //         const body = `This is a quick reminder to notify you that we would be sending goods tomorrow morning from Turkey to Nigeria!
