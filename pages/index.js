import { RequestAgent, IndexNavbar, Footer } from "./../components";
...
const Index = () => {
  return (
    <>
      ...
      <section className="relative flex items-center h-screen pt-16 header max-h-860-px">
            ...
            <div className="pt-32 sm:pt-0">
              ...
              <div className="mt-12">
                <a
                  ...
                  className="px-6 py-4 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-blue-500 rounded shadow outline-none get-started hover:shadow-lg focus:outline-none active:bg-blue-600"
                >
                  Get started
                </a>
                <a
                  href="https://github.com/creativetimofficial/notus-react?ref=nr-index"
                  className="px-6 py-4 mb-1 ml-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-gray-700 rounded shadow outline-none github-star hover:shadow-lg focus:outline-none active:bg-gray-600"
                >
                  Github Star
                </a>
              </div>
        ...
        <div className="relative">
          <Image
            layout="fill"
            objectFit="cover"
            className="absolute top-0 right-0 w-10/12 pt-16 -mt-48 b-auto max-h-860px sm:mt-0 sm:w-6/12"
            src="/pattern.png"
            alt="..."
          />
        </div>
      ...
      <section className="relative pb-40 mt-48 bg-gray-100 md:mt-40">
        <div
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 px-12 ml-auto mr-auto -mt-32 md:w-6/12 md:px-4 lg:w-4/12">
              <div className="relative flex flex-col w-full min-w-0 mb-6 break-words bg-white bg-blue-500 rounded-lg shadow-lg">
                <div className="relative">
                  <Image
                    layout="fill"
                    objectFit="cover"
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full px-12 mt-48 ml-auto mr-auto md:w-4/12 md:px-4">
              ...
              <a
                ...
                className="font-bold text-gray-700 transition-all duration-150 ease-linear hover:text-gray-500"
              >
                View All{" "}
          ...
          {/* <div className="flex flex-wrap items-center pt-32">
            <div className="w-full px-4 mt-32 ml-auto mr-auto md:w-6/12">
              <div className="relative flex flex-wrap justify-center">
                ...
                <div className="w-full px-4 my-4 lg:mt-16 lg:w-6/12">
      ...
      <section className="relative block bg-gray-600 z-1">
        <div className="container mx-auto">
      ...
      <section className="py-20 overflow-hidden bg-gray-600">
        <div className="container pb-64 mx-auto">
          <div className="flex flex-wrap justify-center">
            <div className="w-full px-12 ml-auto mr-auto md:mt-64 md:w-5/12 md:px-4">
              <div className="inline-flex items-center justify-center w-16 h-16 p-3 mb-6 text-center text-gray-500 bg-white rounded-full shadow-lg">
              ...
              <p className="mt-4 mb-4 text-lg font-light leading-relaxed text-gray-400">
                Since{" "}
                <a
                  href="https://tailwindcss.com/?ref=creativetim"
              ...
              <p className="mt-0 mb-4 text-lg font-light leading-relaxed text-gray-400">
                Get it free on Github and please help us spread the news with a
                Star!
              </p>
              <a
                href="https://github.com/creativetimofficial/notus-react?ref=nr-index"
                className="inline-block px-6 py-4 mt-4 mb-1 mr-1 text-sm font-bold text-white uppercase bg-gray-700 rounded shadow outline-none github-star hover:shadow-lg focus:outline-none active:bg-gray-600"
              >
                Github Star
              </a>
            </div>
            ...
            <div className="relative w-full px-4 mt-32 ml-auto mr-auto md:w-4/12">
              <i className="absolute left-auto text-gray-700 fab fa-github -top-150-px -right-100 text-55 opacity-80"></i>
            </div>
          </div>
        </div>
      </section>

      <section className="relative pt-32 pb-16 bg-gray-200">
        <div
          className="absolute top-0 left-0 right-0 bottom-auto w-full h-20 -mt-20"
          style={{ transform: "translateZ(0)" }}
        >
          ...
          <div className="relative z-10 flex flex-wrap justify-center px-12 py-16 -mt-64 bg-white rounded-lg shadow-xl">
            <div className="w-full text-center lg:w-8/12">
              ...
              <div className="flex flex-col mt-10 sm:block">
                <a
                  href="https://www.creative-tim.com/learning-lab/tailwind/react/overview/notus?ref=nr-index"
                  className="px-6 py-4 mb-2 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-blue-500 rounded shadow outline-none get-started hover:shadow-lg focus:outline-none active:bg-blue-600"
                >
                  Get started
                </a>
                <a
                  href="https://github.com/creativetimofficial/notus-react?ref=nr-index"
                  className="px-6 py-4 mb-1 mr-1 text-sm font-bold text-white uppercase bg-gray-700 rounded shadow outline-none github-star hover:shadow-lg focus:outline-none active:bg-gray-600 sm:ml-1"
                >
